...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    KSGuaidViewManager *ksGuaidManager = [KSGuaidViewManager manager];
    ...
    BOOL ret = [_mapManager start:@"SU0mRjwn0IGeVvr4zVO9C4tG4PT6qpKc" generalDelegate:self];
    if (!ret) {
...
//    [NSString stringWithFormat:@"deviceToken ==%@", deviceToken];
...
//    [UNNotificationSound soundNamed:@"tishiyin.caf"];
//
